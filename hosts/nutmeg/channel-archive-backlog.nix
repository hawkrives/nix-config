{ ... }:
{
  services.channelArchive = {
    ...
    channels."technology-connections" = {
      # 72 vids
      enable = false;
      incremental = false;
      ignoreErrors = false;
